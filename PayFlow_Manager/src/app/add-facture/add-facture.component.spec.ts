...
describe('AddFactureComponent', () => {
  ...
  describe('invoice calculations', () => {
    ...
    it('should calculate total for multiple lines', () => {
      ...
      expect(component.nouvelleFacture.montant).toBe(65);
      expect(component.nouvelleFacture.montantRestantAPayer).toBe(65);
      expect(component.nouvelleFacture.montantPayer).toBe(0);
    });
    ...
    it('should update totals when removing a line', () => {
      ...
      expect(component.nouvelleFacture.montant).toBe(45);
      expect(component.nouvelleFacture.montantRestantAPayer).toBe(45);
    });
  });
});
